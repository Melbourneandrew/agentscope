...
export const ptyExecutionFailurePredicates = Object.freeze([
  ...
  "integration.fixture.codex-configuration-built",
  "integration.fixture.codex-configuration-state",
  "integration.fixture.codex-configuration-opened",
  "integration.fixture.codex-configuration-written",
