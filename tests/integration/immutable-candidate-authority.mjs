...
export const ptyExecutionFailurePredicates = Object.freeze([
  ...
  "integration.fixture.codex-model-gate-routes-read",
  "integration.fixture.codex-model-gate-route-validated",
  "integration.fixture.codex-model-gate-control-response",
  "integration.fixture.codex-model-gate-control-ended",
  "integration.fixture.codex-model-gate-control-status-ok",
  "integration.fixture.codex-model-gate-control-json",
  "integration.fixture.codex-model-gate-request-complete",
