...
const rawCommandRegistry = [
  ...
  },
  {
    ...
    diagnostics: [
      ...
      "destination.lifecycle-outcome-unknown",
  ...
  {
    dataSchema: "agentscope.cli.destination-recover.v1",
    diagnostics: [
      "configuration.conflict",
      "configuration.missing",
      "configuration.unavailable",
      "destination.lifecycle-busy",
      "destination.lifecycle-capacity",
      "destination.lifecycle-outcome-unknown",
      "destination.lifecycle-reconciliation-required",
      "destination.lifecycle-unavailable",
    ],
    documentationPage: "cli/destination/recover.mdx",
    id: "destination.recover",
    kind: "command",
    outputModes: ["human", "json", "jsonl"],
    path: ["destination", "recover"],
    summary: "Inspect or recover one pending Local SQLite lifecycle mutation.",
    visibility: "public",
  },
  {
