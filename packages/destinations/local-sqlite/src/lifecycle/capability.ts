...
export const LOCAL_SQLITE_LIFECYCLE_ARTIFACT_GRAMMAR = Object.freeze({
  artifacts: Object.freeze([
    ...
    artifact("recovery-claim", "lifecycle/recovery-claim-<transaction-id>", 1),
...
export const LOCAL_SQLITE_LIFECYCLE_ARTIFACT_GRAMMAR_FINGERPRINT =
  `sha256-${createHash("sha256")
    .update(JSON.stringify(LOCAL_SQLITE_LIFECYCLE_ARTIFACT_GRAMMAR))
    .digest("hex")}` as const;
